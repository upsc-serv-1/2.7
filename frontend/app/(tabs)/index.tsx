...
export default function Home() {
  ...
  const isStrictPyqSource = (input: any) => {
    ...
    // Check for PYQ Book or UPSC CSE in program/category
    const isUpscCse =
...
const styles = StyleSheet.create({
  ...
  streakCard: { flexDirection: 'row', alignItems: 'center', padding: 16, borderRadius: 20, borderWidth: 1 },
  summaryCard: { flexDirection: 'row', alignItems: 'center', padding: 16, borderRadius: 20, borderWidth: 1 },
